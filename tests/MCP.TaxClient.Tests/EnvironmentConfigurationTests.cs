...
public class EnvironmentConfigurationTests
{
    ...
    [Fact]
    public void McpEndpoint_WhenNull_ThrowsArgumentException()
    {
        var original = Environment.GetEnvironmentVariable("McpEndpoint");
        try
        {
            Environment.SetEnvironmentVariable("McpEndpoint", null);
        ...
        {
            Environment.SetEnvironmentVariable("McpEndpoint", original);
        }
    }

    [Fact]
    public void McpEndpoint_WhenEmpty_ThrowsArgumentException()
    {
        var original = Environment.GetEnvironmentVariable("McpEndpoint");
        try
        {
            Environment.SetEnvironmentVariable("McpEndpoint", string.Empty);
            var mcpEndpoint = Environment.GetEnvironmentVariable("McpEndpoint");
    ...
    [Fact]
    public void McpEndpoint_WhenSet_DoesNotThrow()
    {
        var original = Environment.GetEnvironmentVariable("McpEndpoint");
        try
        {
            Environment.SetEnvironmentVariable("McpEndpoint", "http://localhost:5000/mcp");
            var mcpEndpoint = Environment.GetEnvironmentVariable("McpEndpoint");
